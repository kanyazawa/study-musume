...
const HIDE_FOOTER_PATHS = ['/opening', '/tutorial', '/study', '/dialogue', '/character-select', '/story', '/relationship-events', '/multiplayer-match', '/review', '/missions', '/missions-v0', '/writing', '/expression-preview', '/custom-vocab/flashcards', '/reorder-practice'];
