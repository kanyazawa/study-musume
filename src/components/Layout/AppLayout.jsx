...
const HIDE_FOOTER_PATHS = ['/opening', '/tutorial', '/study', '/dialogue', '/character-select', '/story', '/relationship-events', '/seasonal-events', '/ai-tutor-plans', '/multiplayer-match', '/review', '/missions', '/calendar', '/writing', '/expression-preview', '/custom-vocab/flashcards', '/reorder-practice'];
