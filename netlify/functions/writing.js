...
export async function handler(event) {
    ...
    const result = await createWritingEvaluationResponse({
        ...
        geminiModel: process.env.GEMINI_WRITING_MODEL || process.env.GEMINI_CHAT_MODEL || undefined,
        openAiApiKey: process.env.OPENAI_API_KEY,
        openAiModel: process.env.OPENAI_WRITING_MODEL || process.env.OPENAI_CHAT_MODEL || undefined,
        body,
    });
